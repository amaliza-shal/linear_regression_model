          ...
          children: [
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Low', 'Medium', 'High']
                  ...
                  .toList(),
              onChanged: (value) => setState(() => selectedParentalInvolvement = value),
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Low', 'Medium', 'High']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedAccessToResources = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              ...
              items: ['No', 'Yes']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedExtracurricular = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            TextField(
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['No', 'Yes']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedInternetAccess = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            TextField(
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Low', 'Medium', 'High']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedFamilyIncome = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              ...
              items: ['Low', 'Medium', 'High']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedTeacherQuality = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['Positive', 'Neutral', 'Negative']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedPeerInfluence = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            TextField(
            ...
            DropdownButtonFormField<String>(
              ...
              items: ['No', 'Yes']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedLearningDisabilities = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              ...
              items: ['High School', 'College', 'Postgraduate']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedParentalEducation = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              ...
              items: ['Near', 'Moderate', 'Far']
                  .map((e) => DropdownMenuItem(value: e, child: Text(e)))
                  .toList(),
              onChanged: (value) => setState(() => selectedDistanceFromHome = value),
              decoration: const InputDecoration(border: OutlineInputBorder()),
            ),
