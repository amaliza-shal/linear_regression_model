        ...
        child: Column(
          children: [
            ...
            DropdownButtonFormField<String>(
              initialValue: selectedParentalInvolvement,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedAccessToResources,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedExtracurricular,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedMotivation,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedInternetAccess,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedFamilyIncome,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedTeacherQuality,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedPeerInfluence,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedLearningDisabilities,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedParentalEducation,
            ...
            const SizedBox(height: 12),
            DropdownButtonFormField<String>(
              initialValue: selectedDistanceFromHome,
